...
#define RX2_MESSAGE_BUFFER_NUM (10)
...
int main(void)
{
    ...
    flexcan_rx_mb_config_t mbConfig, mbConfig_Rx;
  ...
  //  flexcanConfig.enableLoopBack = true;
    ...
    mbConfig_Rx.format = kFLEXCAN_FrameFormatStandard;
    mbConfig_Rx.type   = kFLEXCAN_FrameTypeData;
    mbConfig_Rx.id     = FLEXCAN_ID_STD(0x456);
    ...
    FLEXCAN_SetFDRxMbConfig(EXAMPLE_CAN, RX_MESSAGE_BUFFER_NUM, &mbConfig, true);
#else
    FLEXCAN_SetRxMbConfig(EXAMPLE_CAN, RX2_MESSAGE_BUFFER_NUM, &mbConfig_Rx, true);
#endif
...
/* Setup Tx Message Buffer. */
    ...
    FLEXCAN_EnableMbInterrupts(EXAMPLE_CAN, 1 << RX2_MESSAGE_BUFFER_NUM);
...
#else
    txFrame.dataWord0 = CAN_WORD0_DATA_BYTE_0(0x22) | CAN_WORD0_DATA_BYTE_1(0x11) | CAN_WORD0_DATA_BYTE_2(0x33) |
...
//    }
//#else
//    rxFrame.dataWord0 = CAN_WORD0_DATA_BYTE_0(0x00) | CAN_WORD0_DATA_BYTE_1(0x00) | CAN_WORD0_DATA_BYTE_2(0x00) |
//                        CAN_WORD0_DATA_BYTE_3(0x00);
//    rxFrame.dataWord1 = CAN_WORD1_DATA_BYTE_4(0x00) | CAN_WORD1_DATA_BYTE_5(0x00) | CAN_WORD1_DATA_BYTE_6(0x00) |
...
//    /* Send data through Rx Message Buffer using polling function. */
//    #if (defined(USE_CANFD) && USE_CANFD)
//        FLEXCAN_TransferFDSendBlocking(EXAMPLE_CAN, RX_MESSAGE_BUFFER_NUM, &rxFrame);
//    #else
//        FLEXCAN_TransferSendBlocking(EXAMPLE_CAN, RX_MESSAGE_BUFFER_NUM, &rxFrame);
//    #endif
//
